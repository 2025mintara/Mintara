  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="relative py-24 md:py-32 px-6 overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-96 h-96 bg-mintara-primary/20 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-mintara-accent/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-mintara-accent/5 to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-[1200px] mx-auto">
          <Card className="relative p-12 md:p-16 bg-gradient-to-br from-mintara-surface/80 to-mintara-primary/10 border-mintara-border overflow-hidden">
            <div className="absolute top-0 right-0 w-96 h-96 bg-mintara-accent/10 rounded-full blur-3xl"></div>
