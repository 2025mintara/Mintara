    ...
    <div className="min-h-screen pt-32 px-6 py-16">
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-semibold text-mintara-text-primary mb-4">Launchpad</h1>
          <p className="text-xl text-mintara-text-secondary">Launch your token with liquidity and community support</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card className="p-8 md:p-12 bg-mintara-surface/50 border-mintara-border backdrop-blur-sm hover:border-mintara-accent/50 transition-all duration-300">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-semibold text-mintara-text-primary">List on DEX</h2>
            </div>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={item} className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-mintara-accent" />
                  <span className="text-mintara-text-primary">{item}</span>
                </div>
              ))}
            </div>
          ...
          <Card className="relative p-8 md:p-12 bg-gradient-to-br from-mintara-surface/80 to-mintara-primary/10 border-mintara-border backdrop-blur-sm overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-mintara-accent/10 rounded-full blur-3xl" />
            <div className="relative">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-mintara-text-primary">Mintara Launchpad</h2>
              ...
              <p className="text-mintara-text-secondary mb-8">
                Our native launchpad will provide comprehensive token launch services with community building, marketing
                support, and guaranteed liquidity.
              </p>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={item} className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-mintara-soft-lime-glow" />
                    <span className="text-mintara-text-primary">{item}</span>
                  </div>
                ))}
              </div>
        ...
        <Card className="p-8 md:p-12 bg-mintara-surface/50 border-mintara-border backdrop-blur-sm">
          <h2 className="text-2xl font-semibold text-mintara-text-primary mb-8 text-center">Why Launch with Mintara?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {whyLaunchWithMintara.map((feature) => (
              <div key={feature.title} className="text-center space-y-3">
                <div className="w-12 h-12 rounded-xl bg-mintara-primary/20 flex items-center justify-center mx-auto">
                  <div className="w-3 h-3 rounded-full bg-mintara-accent" />
                </div>
        ...
        <div className="mt-12 text-center">
          <Card className="p-12 bg-gradient-to-br from-mintara-surface/80 to-mintara-primary/10 border-mintara-border backdrop-blur-sm">
            <h2 className="text-3xl font-semibold text-mintara-text-primary mb-4">Ready to Launch Your Project?</h2>
            <p className="text-mintara-text-secondary mb-8 max-w-2xl mx-auto">
              Join the Base ecosystem and bring your token to market with Mintara's comprehensive launch solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" onClick={() => navigate("/token-builder")}>
                Get Started
              </Button>
